...
export default function EnrollBeginner() {
        ...
        <main className="flex-1 flex items-center justify-center px-4 py-12">
          <div className="bg-card border border-border rounded-2xl p-8 max-w-md w-full text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Thank you for enrolling in the Beginner Package. We'll send you
          ...
          <div className="bg-card border border-border rounded-2xl p-8">
            <div className="mb-8">
              <h1 className="text-3xl font-bold mb-2">
                Enroll in Beginner Package
              </h1>
              <p className="text-muted-foreground">
                Complete your enrollment and get instant access to all course
                materials.
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-6 mb-8 border border-slate-700">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h3 className="text-xl font-bold">Beginner Package</h3>
                  <p className="text-muted-foreground text-sm mt-1">
                    Perfect for newcomers to the stock market
                  </p>
                </div>
              ...
              <div className="bg-slate-800/30 rounded-lg p-4 border border-border">
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm">
                    ...
                    . I also agree to receive course updates and offers via
                    email.
                  </span>
                </label>
              </div>
